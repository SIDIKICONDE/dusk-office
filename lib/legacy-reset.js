...
const DUSK_OFFICE_RESET_KEYS = [
  ...
  "adaptiveFocus.dayStartHour",
  "adaptiveFocus.dayEndHour",
  "adaptiveFocus.defaultLightTheme",
  "adaptiveFocus.defaultDarkTheme",
  "adaptiveFocus.languageOverrides",
  "workspaceFingerprint.enabled",
  "editorAnsi.enabled",
  "editorAnsi.allLanguages",
  "editorAnsi.dimEscapeSequences",
  "editorAnsi.languageIds",
