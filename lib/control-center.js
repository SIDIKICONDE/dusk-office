...
const { THEME_VARIANTS, getThemeDisplayLabel, getThemeKindLabel, stripThemeDisplayLabel, isDuskTheme, isThemeName } = require("./theme-common.js");
const keys = require("./extension-keys.js");
const cfg = require("./configuration.js");
const themes = require("./themes.js");
const autoAdaptive = require("./auto-adaptive.js");
const editorAnsi = require("./editor-ansi.js");
const productIcons = require("./product-icons.js");
const titleBar = require("./title-bar.js");
const { verifyTerminalContrast } = require("./terminal-verify.js");
const { resetAllSettings } = require("./legacy-reset.js");
const { clearWorkspaceFingerprint } = require("./workspace-fingerprint.js");
const log = require("./log.js");
const { openMarketplaceReviewPage, getMarketplaceReviewEnabled } = require("./marketplace-review-prompt.js");
    ...
    [
      ...
      },
      {
        ...
        detail: autoSwitch.enabled
          ? `Light: ${autoSwitch.lightTheme} · Dark: ${autoSwitch.darkTheme}`
          : "Toggle auto switch",
      ...
      ...(getMarketplaceReviewEnabled()
        ...
        : []),
      ...(cfg.getExtensionConfig().get("nythyCleanerRecommendation", true)
        ? [
            {
