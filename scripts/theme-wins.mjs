...
export function themeWinsForKey(k) {
  ...
  if (k.startsWith("editorIndentGuide")) return true;
  if (k.startsWith("editorOverviewRuler")) return true;
  if (k.startsWith("minimap.")) return true;
  /** Diff : harmonisé par `merge-extended-ui-colors` (palette inserted/removed/…). */
  if (k.startsWith("diffEditor.")) return false;
