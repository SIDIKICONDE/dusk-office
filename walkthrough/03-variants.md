...
This isn't a random palette dump. Every variant was designed for a **specific mood,
context, or workflow**.
...
| Variant | Built for |
| --- | --- |
| **Finance** · **Corporate** | Banking, Bloomberg terminals, financial models |
| **Audit** · **Ledger** | SOX compliance, accounting, regulatory code review |
| **Vault** · **Secure** · **Sentinel** | Cybersecurity, secrets, SOC ops |
| **Steward** | Data science, ML pipelines, Jupyter workflows |
| **Voltage** · **Neon** · **Terminal** | DevOps, CLI, infrastructure as code |
| **Luxe** | Premium dark gold — executive presentations & demos |
| **Or** | Bronze-gold on obsidian; treasury & premium dashboards |

## Light — daytime readability

**Light** · **Ivory** · **Dark Ivory** — warm and paper-like, with the same chrome
consistency as the dark family.
